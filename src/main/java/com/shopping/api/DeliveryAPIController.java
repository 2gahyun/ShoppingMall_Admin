...
public class DeliveryAPIController {
    ...
    public Map<String, Object> postDeliveryApiAdd(@RequestBody DeliveryVO vo){
        Map<String, Object> resultMap = new LinkedHashMap<String, Object>();
        // 방법1 - if~else를 이용하는 방법
        boolean b = d_service.addDelivery(vo);
        ...
        // String msg = d_service.addDelivery(vo)?"배송업체 등록에 성공했습니다.":"배송업체 등록에 실패했습니다.";
        // resultMap.put("status", b);
    ...
    public Map<String, Object> getDeliveryApiCheck(@RequestParam String name){
        Map<String, Object> resultMap = new LinkedHashMap<String, Object>();
        boolean b = d_service.isExistDelivery(name);
        resultMap.put("status", b);
        if(b) {
    ...
    public Map<String, Object> getDeliveryList(){
        ...
        List<DeliveryVO> list = d_service.selectDeliveryAll();
