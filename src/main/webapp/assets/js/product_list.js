$(function () {
    ...
    function getProductDate(keyword, cate_seq, offset) {
            ...
            success: function (r) {
                for (let i = 0; i < r.data.length; i++) {
                    let tag =
                        ...
                        '<td>' +
                        '<button class="product_modify" data-seq="' + r.data[i].pi_seq +
                        '">수정</button>' +
                        '</td>' +
                        '<td>' +
                        '<button class="product_delete" data-seq="' + r.data[i].pi_seq +
                        '">삭제</button>' +
                        '</td>' +
                        '</tr>'
    ...
    $("#save").click(function () {
        ...
        if (pi_discount_rate == null || pi_discount_rate == "" || pi_discount_rate ==
            undefined) {
            alert("할인율을 입력하세요");
            return;
        }
